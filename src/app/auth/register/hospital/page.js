...
export default function HospitalRegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (orgError) {
        setError('خطأ في إنشاء المستشفى: ' + orgError.message)
        return
      }
      ...
      <div className="max-w-2xl w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            قم بإنشاء حساب مستشفى جديد للوصول إلى نظام إدارة الصحة
          </p>
        </div>
        ...
        <Card>
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-4">معلومات المستشفى</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Input
                  label="البريد الإلكتروني للمستشفى"
                  type="email"
